        ...
        ***********************************-->
		...
		<div class="sub-header">
			<div class="d-flex align-items-center flex-wrap mr-auto">
				<h5 class="dashboard_bar">Developer Dashboard</h5>
			</div>
		</div>
	</div>
	</div>
							...
							<div class="card">
								<div
									...
									<div class="mb-3">
										...
										<p class="mb-0 fs-12">Lorem ipsum dolor sit amet,
											consectetur</p>
									</div>
									<div class="card-action card-tabs mb-3 style-1">
										<ul class="nav nav-tabs" role="tablist">
											<li class="nav-item"><a class="nav-link active"
												data-toggle="tab" href="#monthly"> Monthly </a></li>
											<li class="nav-item"><a class="nav-link"
												data-toggle="tab" href="#Weekly"> Weekly </a></li>
											<li class="nav-item"><a class="nav-link"
												data-toggle="tab" href="#Today"> Today </a></li>
										</ul>
									</div>
								</div>
									...
									<div class="tab-pane active show fade" id="monthly">
										<div class="table-responsive">
											<table
												...
												<tbody>
													<tr>
														<td><span> <svg width="50" height="50"
														...
														<td class="wspace-no"><svg class="mr-2" width="24"
																...
																xmlns="http://www.w3.org/2000/svg">
																	...
																	fill="#FFAB2D"></path>
																</svg> <span class="font-w600 text-black">Bitcoin</span></td>
														<td><span class="text-black">06:24:45 AM</span></td>
														<td><span class="font-w600 text-black">+$5,553</span>
														</td>
														<td><a class="btn btn-outline-success float-right"
													...
													<tr>
														...
														<td class="wspace-no"><svg class="mr-1" width="24"
																height="24" viewBox="0 0 24 24" fill="none"
																xmlns="http://www.w3.org/2000/svg">
																	<path
																	...
																	fill="#DC3CCC"></path>
																</svg> <span class="font-w600 text-black">Ethereum</span></td>
														<td><span class="text-black">06:24:45 AM</span></td>
														<td><span class="font-w600 text-black">+$5,553</span>
														</td>
														<td><a class="btn btn-outline-light float-right"
													...
													<tr>
														...
														<td class="wspace-no"><svg class="mr-2" width="24"
																...
																xmlns="http://www.w3.org/2000/svg">
																	...
																	fill="#FF782C"></path>
																</svg> <span class="font-w600 text-black">Monero</span></td>
														<td><span class="text-black">06:24:45 AM</span></td>
														<td><span class="font-w600 text-black">-$912</span></td>
														<td><a class="btn btn-outline-danger float-right"
													...
													<tr>
														...
														<td class="wspace-no"><svg class="mr-1" width="24"
																...
																xmlns="http://www.w3.org/2000/svg">
																	...
																	fill="#5F5F5F"></path>
																</svg> <span class="font-w600 text-black">Litecoin</span></td>
														<td><span class="text-black">06:24:45 AM</span></td>
														<td><span class="font-w600 text-black">+$7,762</span>
														</td>
														<td><a class="btn btn-outline-success float-right"
															href="javascript:void(0);">Completed</a></td>
													</tr>
								...
								<div class="card-footer border-0 p-0 caret mt-1">
									<a href="coin-details.html" class="btn-link"><i
