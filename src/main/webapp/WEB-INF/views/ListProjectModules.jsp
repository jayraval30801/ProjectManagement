							...
							<div class="card-body">
								<div class="table-responsive">
									<div id="example_wrapper" class="dataTables_wrapper">
										...
										<table id="listModules" class="display dataTable"
											...
											<tbody>
												<c:forEach items="${projectmodules}" var="pm">
													<tr>
														<td>${pm.moduleId}</td>
														<td>${pm.moduleName}</td>
														...
														<td>${pm.statusName}</td>
														<td><a href="deleteprojectmodules/${pm.moduleId}">Delete</a>|<a
															href="editprojectmodule?moduleId=${pm.moduleId}">Edit</a></td>
													</tr>
												</c:forEach>
											</tbody>
										</table>
