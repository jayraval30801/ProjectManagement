							...
							<div class="card-body">
								<div class="table-responsive">
									<div id="example_wrapper" class="dataTables_wrapper">
										<table id="listStatuses" class="display dataTable"
											...
											<tbody>
												<c:forEach items="${statuses}" var="status">
													<tr>
														...
														<td><a href="deletestatus/${status.statusId}">Delete</a>
															| <a href="editstatus?statusId=${status.statusId}">Edit</a></td>
													</tr>
												</c:forEach>
											</tbody>
										</table>
