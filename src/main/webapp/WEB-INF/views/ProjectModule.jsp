				...
				<div class="col-lg-12">
					<div class="card">
						<div class="card-header">
							<h4 class="card-title">New Project Module</h4>
						</div>
						<div class="card-body">
							<div class="basic-form">
								<form class="form-valide-with-icon" action="saveprojectmodule"
									method="post" novalidate="novalidate">
									<div class="form-group is-invalid">
										<label class="text-label">Module name </label>
									...
									<div class="form-group is-invalid">
										...
										<div class="input-group">
											...
											<select name="statusId" class="form-control">
												...
												<div id="val-username1-error"
													class="invalid-feedback animated fadeInUp"
													style="display: block;">Please select a status name</div>
										</div>
									</div>
