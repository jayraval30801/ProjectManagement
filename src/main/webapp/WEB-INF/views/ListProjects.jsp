						...
						<div class="card">
							...
							<div class="card-body">
								<div class="table-responsive">
									...
									<table id="listProjects" class="display dataTable"
												...
												<c:forEach items="${projects}" var="p">
													<tr>
														...
														<td><a href="deleteproject/${p.projectId}">Delete</a>
															...
															| <a href="viewteam?projectId=${p.projectId}">View
																Team</a> | <a href="addteammember?projectId=${p.projectId}">Add
																Member</a> <a href="viewtask?projectId=${p.projectId}">Task</a>
														</td>
													</tr>
												</c:forEach>
											</tbody>
